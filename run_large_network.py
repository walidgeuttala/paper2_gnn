...
for i in range(1, number_folders):
    ...
    models_path = [filee for filee in files_names if  filee.startswith("last_second_model_weights_trail")]
    args_file_name = [filee for filee in files_names if filee.startswith("second_Data_dataset_Hidden_")][0]
...
print(test_results)
test_results.to_csv('test_resutls_large_networks2.csv')
