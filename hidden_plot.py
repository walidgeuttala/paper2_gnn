import pandas as pd
var = ''
df1 = pd.read_csv(var+'test_resutls_small_networks2.csv', index_col=False)
df2 = pd.read_csv(var+'test_resutls_large_networks2.csv', index_col=False)
...
def func(df):
    ...
    for arch in unique_architectures:
        ...
        plt.title(f'Architecture: {arch.capitalize()}', fontsize=24)
